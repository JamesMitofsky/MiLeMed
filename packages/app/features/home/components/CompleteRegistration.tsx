//TODO eventually centralize this between web and native, but for now just copy paste to avoid confetti on mobile
// taken from screen.web.tsx and just deleted all the confetti
